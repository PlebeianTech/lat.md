...
import { wikiLinkSyntax } from '@plebeiantech/lat.md-core/extensions/wiki-link/syntax';
import { wikiLinkFromMarkdown } from '@plebeiantech/lat.md-core/extensions/wiki-link/from-markdown';
